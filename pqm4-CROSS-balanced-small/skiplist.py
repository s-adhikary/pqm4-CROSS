skip_list = [
    ...
    {'scheme': 'cross-sha3-r-sdp-1-balance', 'implementation': 'ref', 'estmemory': 234496},
    {'scheme': 'cross-sha3-r-sdp-1-small', 'implementation': 'ref', 'estmemory': 477184},
    {'scheme': 'cross-sha3-r-sdp-3-fast', 'implementation': 'ref', 'estmemory': 365568},
    {'scheme': 'cross-sha3-r-sdp-3-balance', 'implementation': 'ref', 'estmemory': 365568},
    {'scheme': 'cross-sha3-r-sdp-3-small', 'implementation': 'ref', 'estmemory': 477184},
    {'scheme': 'cross-sha3-r-sdp-5-fast', 'implementation': 'ref', 'estmemory': 477184},
    {'scheme': 'cross-sha3-r-sdp-5-balance', 'implementation': 'ref', 'estmemory': 477184},
    ...
    {'scheme': 'cross-sha3-r-sdpg-1-balance', 'implementation': 'ref', 'estmemory': 143360},
    ...
    {'scheme': 'cross-sha3-r-sdpg-3-balance', 'implementation': 'ref', 'estmemory': 230400},
    {'scheme': 'cross-sha3-r-sdpg-3-small', 'implementation': 'ref', 'estmemory': 477184},
    {'scheme': 'cross-sha3-r-sdpg-5-fast', 'implementation': 'ref', 'estmemory': 440320},
    {'scheme': 'cross-sha3-r-sdpg-5-balance', 'implementation': 'ref', 'estmemory': 440320},
    {'scheme': 'cross-sha3-r-sdpg-5-small', 'implementation': 'ref', 'estmemory': 477184},
